...
@section('content')
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            {{-- Start of product edit form --}}
            <form action="{{ route('products.update', $product->id) }}" method="POST">
                @csrf {{-- CSRF token for form security --}}
                @method('PUT') {{-- Use the HTTP PUT method to update the product --}}
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control {{ $errors->has('sku') ? 'is-invalid' : '' }}" id="sku" name="sku" value="{{ old('sku', $product->sku) }}" required>
                    @if ($errors->has('sku'))
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" id="price" name="price" value="{{ old('price', $product->price) }}" required>
                    @if ($errors->has('price'))
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" class="form-control {{ $errors->has('cost') ? 'is-invalid' : '' }}" id="cost" name="cost" value="{{ old('cost', $product->cost) }}">
                    @if ($errors->has('cost'))
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control {{ $errors->has('quantity') ? 'is-invalid' : '' }}" id="quantity" name="quantity" value="{{ old('quantity', $product->quantity) }}" required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" id="description" name="description">{{ old('description', $product->description) }}</textarea>
